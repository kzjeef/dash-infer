...
# Strip -real/-virtual suffixes for CUTLASS (expects plain arch numbers)
set(_CUTLASS_ARCHS "")
foreach(_arch ${CMAKE_CUDA_ARCHITECTURES})
    string(REGEX REPLACE "(-real|-virtual)$" "" _arch_clean "${_arch}")
    list(APPEND _CUTLASS_ARCHS "${_arch_clean}")
endforeach()
list(REMOVE_DUPLICATES _CUTLASS_ARCHS)
string(REPLACE ";" " " CUTLASS_NVCC_ARCHS_STR "${_CUTLASS_ARCHS}")
set(CUTLASS_NVCC_ARCHS "${CUTLASS_NVCC_ARCHS_STR}" CACHE STRING "The SM architectures requested.")
